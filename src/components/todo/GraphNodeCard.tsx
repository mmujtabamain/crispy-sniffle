  ...
  return (
    ...
    >
      ...
      <div className="graph-node-meta">
        <span className={`pill priority-${data.priority || 'medium'}`}>{data.priority || 'medium'}</span>
        <span className={`pill status-${data.status || 'todo'}`}>{data.status || 'todo'}</span>
      ...
      {typeof progress === 'number' && (
        <div className="graph-progress" role="status" aria-label={`Branch progress ${progress}%`}>
